...
export const UpdateTicketView: React.FC = () => {
  const { tickets, activeTicketId, updateTicket, navigateTo, isSubmitting } = useCRM();
      ...
      <div className="hud-box" style={{ padding: '32px' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '16px', borderTop: '1px solid var(--border-dim)', paddingTop: '24px' }}>
            <button type="button" className="btn-secondary" onClick={() => navigateTo('detail', ticket.ticket_id)} disabled={isSubmitting}>
              Cancel
            </button>
