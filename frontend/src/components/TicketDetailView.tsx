      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          ...
          <button className="btn-danger" onClick={() => {
            if (window.confirm(`Are you sure you want to delete this ticket and its associated note?`)) {
        ...
        <div className="hud-box" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {ticket.note ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', flexGrow: 1, justifyContent: 'center' }}>
              ...
              <button className="btn-primary" style={{ alignSelf: 'center' }} onClick={() => navigateTo('update', ticket.ticket_id)}>
                + Add Note
              </button>
            </div>
          )}
